...
const nyev_qa = [
    ...
    { q: 'Quem é Nyev quando não há o outro para cuidar?', a: 'Acho que apenas uma pessoa solitária, presa em seu canto enquanto se perde nos pensamentos.' },
    { q: 'Se tirassem sua empatia de você, o que restaria?', a: 'Majoritriamente coisas pessimistas, gosto de pensar que as pessoas que trazem minhas melhores características. Mas acho que mesmo sem ligar para elas, eu ainda seria gentil, eu espero.' },
    { q: 'Qual seria sua maior derrota?', a: 'Perder alguém por conta de minhas próprias ações, espero que meu impacto na vida dos outros seja apenas positivo.' },
    { q: 'Qual é a mentira que você conta para continuar seguindo em frente?', a: 'Que um dia tudo irá valer a pena. Me preocupo que o futuro que me aguarda faça com que tudo que vivi seja inútil, e às vezes as preocupações viram grandes espirais de dúvidas existenciais.' },
    { q: 'Se proteger alguém significasse se tornar um monstro, você aceitaria?', a: 'Não sei, não gosto de me imaginar na pele de um monstro, talvez se fosse um monstro justificado, dependeria muito da situação também... Acho que só pelo Imra.' },
    { q: 'Como seria seu final feliz?', a: 'Poder descansar em algum lugar calmo e silêncio, somente eu e o Imra, olhando para a paisagem com o coração preenchido.' },
];
